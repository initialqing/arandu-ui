...
<template>
 <div class="flex flex-row">
    <MyButton icon="edit" round plain >编辑</MyButton>
    <MyButton icon="checkmark" round plain >删除</MyButton>
    <MyButton icon="message-queue" round plain >分享</MyButton>
    <MyButton icon="search" round plain >搜索</MyButton>
 </div>
</template>
```
